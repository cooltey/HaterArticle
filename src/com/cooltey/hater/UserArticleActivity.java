...
public class UserArticleActivity extends SherlockFragmentActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// get bundle and chg url
		Intent intent 				= this.getIntent();
		Bundle bundle 				= intent.getExtras();
		String get_hm_name = bundle.getString("hm_name");
		try{
			articleUrl = articleUrl + "hm_name=" + URLEncoder.encode(get_hm_name, "utf-8") + "&orderby=date&category=";
		}catch(Exception e){
