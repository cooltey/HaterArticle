...
public class MyArticleActivity extends SherlockFragmentActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MobileCore.init(MyArticleActivity.this, "", MobileCore.LOG_TYPE.PRODUCTION);
		MobileCore.getSlider().setContentViewWithSlider(MyArticleActivity.this, R.layout.activity_main);
